...
import com.uh.starlite.exception.InvalidCampusCodeException;
...
public class CampusService {
     ...
     */
    public CampusService(ObjectMapper objectMapper, @Value("${starlite.data.campuses-file}") Resource campusesFile) throws IOException {
        // load json
